...
ggplot() +
  ...
  labs(title = "Scatter Plot of Normal and \n Logistic Distributions", x = "Normal Data", y = "Logistic Data")
```
...
ggplot(merged_data, aes(x = PM2.5_AQI_Value, y = Annual_Lung_Cancer_Deaths, color = Country)) +
  ...
  geom_text(aes(
    ...
    size = ifelse(Country == "China", 4, 2)  # Make China's text larger
  ...
  theme(
    plot.title = element_text(color = "brown", face = "bold", size = 8.5),
...
ggplot(filtered_data, aes(x = PM2.5_AQI_Value, fill = Country)) +
  ...
  theme(
    plot.title = element_text(size = 10, face = "bold"),  # Center title
